...
public class Program{
	...
	public static final int ECO_SIZE = 50;
	public static final int SQ_SIZE = 20;
	public static final double ANIMAL_DENSITY = 0.05;
	public static final int PREY_ENERGY_INIT = 15;
	public static final int PREY_REP_THRESH = 100;
	public static final int PREDATOR_FEED_ENERGY = 15;
	public static final int PREDATOR_ENERGY_INIT =25;
	public static final int PREDATOR_REP_THRESH = 100;
	...
	public static void main(String[] args){
	      ...
	      frame.pack();
				...
				Predator.predatorFeedEnergy = PREDATOR_FEED_ENERGY;
				Ecosystem.preyRepThresh = PREY_REP_THRESH;
				Ecosystem.predatorRepThresh = PREDATOR_REP_THRESH;
				Ecosystem.preyEnergyInit = PREY_ENERGY_INIT;
				Ecosystem.predatorEnergyInit = PREDATOR_ENERGY_INIT;
